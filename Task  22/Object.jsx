...
function Object() {
    ...
    const [newBuildin, setNewBuildin] = useState('')
    ...
    return (
        ...
        <div className="my-4 d-flex flex-column align-items-center">
            ...
            <button className="align-self-end me-4 mb-4 py-0 rounded-0 btn btn-outline-primary" onClick={empBtn}>Check Task 22.1</button>

            <h1 className="mb-5 mt-4">Task 22.2</h1>
                            ...
                            <div className="modal-content">
                                <div className="modal-body d-flex flex-column align-items-center mx-3">
                                    ...
                                    <div className="mt-3 d-flex align-items-center justify-content-between w-100">
                                        ...
                                        <input type="text" className="p-1 px-2 border-1 rounded" onChange={(e) => setNewBuildin(e.target.value)} value={newBuildin}/>
                                    </div>
